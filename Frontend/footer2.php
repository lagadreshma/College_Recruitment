    ...
    <section class="footer-section">
      ...
      <div class="footer">
         ...
         <div class="footer-1">
           ...
           <div class="logo">
              <img src="images1/jobportallogo.jpg" alt="" width="60px" height="60px" style="border-radius:50%;">
              <h2><a href="home.php">naukri<span>4U</span></a></h2>
          </div>
         ...
         <div class="footer-2">
           ...
           <hr>
           <p class = "copyright"> &copy;Copyright 2023 - Reshma Lagad </p>
